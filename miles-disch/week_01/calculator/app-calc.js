...
var areaOfCircle = function (radius){
	var unroundedResult = (Math.PI * radius * radius);
...
var AllOfTheAboveNumber = function (number){
	var halfResult = halfNumber(number);
	var squareResult = squareNumber(halfResult);
	var AreaResult = areaOfCircle(squareResult);
	var percentageResult = percentOf(AreaResult, squareResult);
	var result = percentageResult;
	return result;
} 
console.log(AllOfTheAboveNumber(1))
